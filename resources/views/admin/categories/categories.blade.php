         ...
         <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
               ...
               <h6 class="font-weight-normal mb-0">Categories</h6>
                  ...
                  href="{{ url('admin/add-edit-category') }}" calss="btn btn-block btn-primary">Add Category</a>
                     ...
                     <table id="categories" class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              "{{ $category['id'] }}" href="javascript:void(0)">
                            ...
                            <?php  /* <a title="Category" class="confirmDelete" 
